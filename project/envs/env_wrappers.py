...
from project.utils.util import tile_images
...
class ShareSubprocVecEnv(ShareVecEnv):
    ...
    def get_obs_move_feats_size(self):
        self.remotes[0].send(('get_obs_move_feats_size', None))
        return self.remotes[0].recv()

    def get_obs_enemy_feats_size(self):
        self.remotes[0].send(('get_obs_enemy_feats_size', None))
        return self.remotes[0].recv()

    def get_obs_ally_feats_size(self):
        self.remotes[0].send(('get_obs_ally_feats_size', None))
        return self.remotes[0].recv()
