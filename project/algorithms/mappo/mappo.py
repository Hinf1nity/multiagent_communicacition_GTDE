...
from project.utils.util import get_gard_norm, huber_loss, mse_loss
from project.utils.valuenorm import ValueNorm
...
class MAPPO:
    def __init__(self, args, policy, device=torch.device("cpu")):
        ...
        assert (self._use_popart and self._use_valuenorm) == False, "use_popart and use_valuenorm cannot be True at the same time"
    ...
    def cal_value_loss(self, values, value_preds_batch, returns_batch, active_masks_batch):
        ...
        if self._use_popart or self._use_valuenorm:
            ...
            error_clipped = self.value_normalizer.normalize(
                returns_batch) - value_pred_clipped
    ...
    def ppo_update(self, sample, update_actor=True):
        ...
        values, actions_log_probs, dist_entropy = self.policy.evaluate_actions(
            share_obs_batch,
            obs_batch,
            rnn_states_batch,
        ...
        imp_weights = torch.exp(
            actions_log_probs - old_action_log_probs_batch)
